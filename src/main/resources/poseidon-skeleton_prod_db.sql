...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 31 juil. 2022 à 20:16
...
--
-- Base de données : `poseidon-skeleton_prod_db`
--

-- --------------------------------------------------------
CREATE DATABASE IF NOT EXISTS `poseidon-skeleton_test_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `poseidon-skeleton_test_db`;
...
(1, 'Account A', NULL, NULL, NULL, NULL, NULL, 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Bank'),
(2, 'Account B', NULL, NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Social');
